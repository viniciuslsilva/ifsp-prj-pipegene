...
insert into pipegine_platform.project(id, name, description, owner_id)
    values ('f2d6a949-8bb5-4df5-8ca7-e5b8d2292488'::uuid, 'project 1 test', 'project 1 desc',
...
INSERT INTO pipegine_platform.pipeline(id, project_id, description)
    VALUES('959f2ff3-ed29-435b-83bb-c8390f6385bf'::uuid, 'f2d6a949-8bb5-4df5-8ca7-e5b8d2292488'::uuid, 'pipeline description');
